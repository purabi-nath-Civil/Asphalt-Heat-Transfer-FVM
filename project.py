...
RAIN_TEMP = 25.0 # Temperature during rain

# 5. INITIAL CONDITION SETUP
T = np.ones(Nx) * T_initial
T[0] = T_top_initial + CNG_EXHAUST_HEAT # Top boundary: 81C
...
for n in range(Nt):
    ...
    # FVM Heat Equation for internal points
...
# 8. ZIP ALL GRAPHS INTO ONE FILE
with zipfile.ZipFile('result.zip', 'w') as zipf:
    for file in saved_files:
        zipf.write(file)

print("\nSimulation Finished! All 6 graphs saved in result.zip")